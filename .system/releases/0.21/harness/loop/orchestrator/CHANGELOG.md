...
| 0.1.4 | 2026-07-01 | os-reshape P2: OS_ROOT boot-root indirection (explicit runtime root for sealed/launcher boots; default file-relative derivation unchanged). |
