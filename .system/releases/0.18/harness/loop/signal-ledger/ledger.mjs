#!/usr/bin/env node
/**
 * signal-ledger — CANDIDATE (pre-admission; see governance/rules/harness-admission.md), not admitted. See
 ...
 */
import { realpathSync, appendFileSync, mkdirSync, readFileSync, existsSync } from 'node:fs'
