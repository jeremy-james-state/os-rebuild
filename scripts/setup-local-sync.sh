...
#
# What this installs: a launchd job that runs scripts/sync-supabase.mjs every 30 minutes.
...
<plist version="1.0"><dict>
  ...
  <array><string>${NODE}</string><string>${REPO}/scripts/sync-supabase.mjs</string></array>
